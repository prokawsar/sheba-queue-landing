<!-- <div class="bg-slate-800">
  <div class="container mx-auto text-white flex flex-row justify-center">
    Footer
  </div>
</div> -->
  ...
  <div class="container mx-auto text-white p-3">
    <div class="grid xl:grid-cols-5 gap-6 py-12">
      <div class="xl:col-span-2">
        <a href="index.html">
          <img src="/images/logo.png" alt="logo" class="p-2 h-20" />
        </a>
        <p class="text-gray-500/80 mt-5 lg:w-4/5">
          Make your web application stand out with high-quality team.
        </p>
      </div>
    ...
    <div class="border-t border-t-gray-700 py-6">
