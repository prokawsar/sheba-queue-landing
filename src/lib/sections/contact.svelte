...
<div id="contact" class="bg-gray-100 pt-10 w-full">
  <div class="relative py-10">
    <div
      class="container mx-auto flex flex-col justify-center sm:flex-row text-white"
    >
...
<div class="flex w-full">
  <div
    class="lg:flex items-center container px-10 mx-auto flex-row w-full justify-center"
  >
    <div class="lg:w-1/2">
      <div class="mb-6 rounded-[0.1875rem]">
        <div class="py-12">
            ...
            <div class="flex gap-6">
              <div class="md:w-1/2">
                <div class="mb-5">
                  <label
                    for="firstname"
                    class="text-sm font-medium mb-1 text-gray-600"
